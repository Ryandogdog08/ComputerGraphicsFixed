...
Instance::Instance(glm::vec3 position, glm::vec3 rotation, glm::vec3 scale, Mesh* mesh, aie::ShaderProgram* shader)
{
    m_transform = makeTransform(position,rotation,scale);
    m_mesh = mesh;
    m_shader = shader;
}
